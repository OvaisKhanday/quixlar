...
export default function Home() {
  ...
  return (
    <main className='px-10 lg:px-5 py-4 md:py-10 max-w-7xl mx-auto'>
      ...
      <div className='flex flex-col lg:flex-row gap-6 justify-center mt-10 items-center text-center'>
        ...
        <Image src={"/quiz-take.png"} className='shadow-xl rounded-lg' alt='picture of quiz' width={500} height={700} />
      </div>
      <div className='my-2'>
        <hr />
